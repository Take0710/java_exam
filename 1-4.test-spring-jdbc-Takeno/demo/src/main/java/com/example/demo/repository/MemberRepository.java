...
public class MemberRepository {
	...
	public Member save(Member member) {
		...
		if (member.getId() == null) { // ←正しい条件に修正する
			String insertSql = "INSERT INTO test_members(id,name,age,dep_id) VALUE (id,name,age,dep_id)";// "ここにSQL文を書く";
			template.update(insertSql, param);
			// ここに実行処理を書く

		} else {
			String updateSql = " UPDATE test_members SET id=:id";// "ここにSQL文を書く"
